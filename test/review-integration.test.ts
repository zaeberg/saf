...
function dependencies(fixture: Awaited<ReturnType<typeof reviewFixture>>, ralphex: ReviewDependencies["ralphex"]): ReviewDependencies {
  ...
  return { execute: executor(fixture.root), github: async () => success(adapter), ralphex, validation: async () => success([]) };
}
