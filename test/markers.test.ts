...
import { hashPlan, normalizePlan, parseMarkers, serializeMarker, type ApprovedPlanMarker, type RunMarker } from "../src/status/markers.js";
...
describe("SAF markers", () => {
  ...
  it("renders a visible summary for run markers", () => {
    ...
    expect(parseMarkers([{ id: 1, body: runBody }], 42)).toMatchObject({ run, findings: [] });
  });
