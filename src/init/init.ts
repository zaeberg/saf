...
function createConfig(repository: string, owner: string, number: number, defaultBranch: string, commands: string[]): SafConfigV1 {
  return { version: 1, github: { repository, project: { owner, number } }, repository: { defaultBranch }, documentation: { plansDirectory: "docs/plans" }, planning: { adapter: "claude-glm" }, execution: { adapter: "ralphex-codex", maxConcurrentRuns: 1, tasksOnly: false }, review: { adapter: "ralphex-codex", externalReviewTool: "codex" }, validation: { commands } };
}
